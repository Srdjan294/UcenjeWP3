...
-- Izvucite sve artikle, cijene i količine sa primke
-- 1/2008
...
-- oni koji su prešli prag od milijun eura
...
-- koliko moje srce kuca za moju dragu

-- datumske

select datediff(Day,'1990-10-13 13:45:00',getdate())*24*60*70;
...
select concat(trim(ime), ' ', trim(prezime)) as kupac from kupci;
