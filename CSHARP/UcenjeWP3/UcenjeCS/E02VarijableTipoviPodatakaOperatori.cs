...
namespace UcenjeCS
{
    internal class E02VarijableTipoviPodatakaOperatori
    {
        public static void Izvedi()
        {
            ...
            Console.WriteLine(CijeliBroj);  // ovo je korištenje varijable
            ...
            double vdb = 0.423532456242462634534525;
            ...
            Console.WriteLine(i / (float)j);  // 0.6666  (float) -> cast u float tip podatka
            ...
            Console.WriteLine(dbroj % 10);  // modulo je ostatak nakon cijelobrojnog dijeljenja
